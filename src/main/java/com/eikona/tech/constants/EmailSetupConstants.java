...
public class EmailSetupConstants {
	...
	public static final String EMPLOYEE_SHIFT_INFO = "Dear Sir/Madam,\n\n"+
			"Please find the attachment regarding the SF employee shift info from %s to %s.\n\n"+
			"This is a system generated report.\n\n"+
			"Regards,\n"+
			"MATA Security Team";
	
	public static final String PROFILE_CREATION_AND_INACTIVE_PROFILE = "Dear Sir/Madam,\n\n"+
			 "%s's update of below attached\n "+
			"1) New employees enrolled\n"+
			"2) Employees marked Inactive\n"+
			"This is a system generated report.\n\n"+
			"Regards,\n"+
			"MATA Security Team";
	
	public static final String OFFLINE_DEVICE =  "Dear Sir/Madam,\n\n"+
			"The following devices are found to be offline since last 30 minutes.\n%s\n\n"+
			"This is a system generated report.\n\n"+
			"Regards,\n"+
			"MATA Security Team";
}
