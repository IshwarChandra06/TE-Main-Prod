...
public final class ApplicationConstants {public static final String  HTTP_COLON_DOUBLE_SLASH = "http://";
...
public static final String  DATE_TIME_FORMAT_OF_US_SEPARATED_BY_T = "yyyy-MM-dd'T'HH:mm:ss.SSS";
public static final String  DATE_TIME_FORMAT_OF_US_WITH_ZONE ="yyyy-MM-dd'T'HH:mm:ss.SSSZ";
public static final String  DATE_TIME_FORMAT_OF_US_WITH_MILLISECOND ="yyyy-MM-dd HH:mm:ss.sss";
