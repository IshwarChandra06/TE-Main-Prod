...
public class DailyReport implements Serializable {
	...
	@Column
	private String lessThanTwo;
	
	@Column
	private String lessThanFour;
	
	@Column
	private String lessThanSix;
	
	@Column
	private String lessThanEight;
	
	@Column
	private String greaterThanTen;
	...
	public String getLessThanTwo() {
		return lessThanTwo;
	}

	public void setLessThanTwo(String lessThanTwo) {
		this.lessThanTwo = lessThanTwo;
	}

	public String getLessThanFour() {
		return lessThanFour;
	}

	public void setLessThanFour(String lessThanFour) {
		this.lessThanFour = lessThanFour;
	}

	public String getLessThanSix() {
		return lessThanSix;
	}

	public void setLessThanSix(String lessThanSix) {
		this.lessThanSix = lessThanSix;
	}

	public String getLessThanEight() {
		return lessThanEight;
	}

	public void setLessThanEight(String lessThanEight) {
		this.lessThanEight = lessThanEight;
	}

	public String getGreaterThanTen() {
		return greaterThanTen;
	}

	public void setGreaterThanTen(String greaterThanTen) {
		this.greaterThanTen = greaterThanTen;
	}
