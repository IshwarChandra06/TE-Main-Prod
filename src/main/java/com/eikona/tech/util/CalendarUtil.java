...
import static com.eikona.tech.constants.ApplicationConstants.DEPRECATION;
...
public class CalendarUtil {
	...
	public Date getNextOrPreviousDate(Date date, int day, int hr, int min, int sec) {
		Calendar calender = Calendar.getInstance();
		calender.setTime(date);
		calender.add(Calendar.DATE, day);
		calender.set(Calendar.HOUR, hr);
	...
	public Date setDayInCalendar(Date date, int day, int hr, int min, int sec) {
		Calendar calender = Calendar.getInstance();
		calender.setTime(date);
